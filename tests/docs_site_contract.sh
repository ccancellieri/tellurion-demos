...
require_text docs/index.html 'Tellurion v0.4.0 source is public.'
...
require_text docs/index.html 'https://github.com/ccancellieri/tellurion-demos'
require_text docs/index.html 'https://github.com/ccancellieri/tellurion-demos/releases/tag/tellurion-v0.3.0'
require_text docs/index.html 'href="../proof/"'
reject_text docs/index.html 'Public engine source launch pending'
require_text docs/index.html 'Product evidence: public Tellurion v0.4.0 release-candidate source'
require_text docs/index.html 'Documentation snapshot: 2026-08-31'
reject_text docs/index.html 'Documentation snapshot: 2026-08-30'
require_text docs/index.html 'Preview · public source'
require_text docs/index.html 'Shapefile ZIP'
require_text docs/index.html 'Server wiring and a public demo remain incomplete.'
require_text docs/index.html 'Preview · public source'
