...
require_text docs/index.html 'Public engine source launch pending'
...
reject_text docs/index.html 'https://github.com/ccancellieri/tellurion/'
reject_text docs/index.html 'https://github.com/ccancellieri/tellurion"'
require_text docs/index.html 'source archive is not an installable Tellurion binary'
require_text docs/index.html 'Product evidence: public Tellurion 0.3.0 demo artifacts'
